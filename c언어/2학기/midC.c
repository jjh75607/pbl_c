...
void search(char (*ptr1)[50], char (*ptr2)[50]);
void delete(char (*ptr1)[50], char (*ptr2)[50]);
void add(char (*ptr1)[50], char (*ptr2)[50]);
void print(char (*ptr1)[50], char (*ptr2)[50]);
void game(char (*ptr1)[50], char (*ptr2)[50]);
...
int main() {
    ...
    while (1) {
        ...
        if (index == 1) {
            search(wordsPtr, meaningsPtr);
        } else if(index == 2) {
            delete(wordsPtr, meaningsPtr);
        } else if(index == 3) {
            add(wordsPtr, meaningsPtr);
        } else if(index == 4) {
            print(wordsPtr, meaningsPtr);
        } else if(index == 5) {
            system("clear"); // 현재 사용하는 운영체제가 윈도우가 아니라서 다른 명령어를 사용했습니다.
        } else if(index == 6) {
            game(wordsPtr, meaningsPtr);
        } else {
